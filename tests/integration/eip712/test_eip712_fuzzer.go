...
func (s *TestSuite) generateRandomPayload(numMessages int) gjson.Result {
...
func (s *TestSuite) createRandomJSONObject() gjson.Result {
	var err error
	payloadRaw := ""
...
func (s *TestSuite) createRandomJSONField(t int, depth int) interface{} {
...
func (s *TestSuite) createRandomJSONNestedArray(depth int) []interface{} {
...
func (s *TestSuite) createRandomJSONNestedObject(depth int) interface{} {
...
func (s *TestSuite) createRandomJSONNestedField(depth int) interface{} {
...
func (s *TestSuite) createRandomBoolean() bool {
	return rand.Intn(2) == 0
}

func (s *TestSuite) createRandomFloat() float64 {
	return (rand.Float64() - 0.5) * params.randomFloatRange
}

func (s *TestSuite) createRandomString() string {
...
func (s *TestSuite) createRandomIntInRange(minInt int, maxInt int) int {
