...
//
//	mockgen -source=./x/vm/types/interfaces.go -package=testutil -destination=./x/vm/wrappers/testutil/mock.go -exclude_interfaces=ConsensusParamsKeeper
//
...
import (
	...
	types3 "github.com/shardeum/shardeum-evm/x/feemarket/types"
...
func (m *MockErc20Keeper) GetERC20PrecompileInstance(ctx types.Context, arg1 common.Address) (vm.PrecompiledContract, bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockErc20KeeperMockRecorder) GetERC20PrecompileInstance(ctx, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEvmHooksMockRecorder) PostTxProcessing(ctx, sender, msg, receipt any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetDenomMetaData indicates an expected call of GetDenomMetaData.
func (mr *MockBankWrapperMockRecorder) GetDenomMetaData(ctx, denom any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetSupply indicates an expected call of GetSupply.
func (mr *MockBankWrapperMockRecorder) GetSupply(ctx, denom any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// IterateAccountBalances indicates an expected call of IterateAccountBalances.
func (mr *MockBankWrapperMockRecorder) IterateAccountBalances(ctx, account, cb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// IterateTotalSupply indicates an expected call of IterateTotalSupply.
func (mr *MockBankWrapperMockRecorder) IterateTotalSupply(ctx, cb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
