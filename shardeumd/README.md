# Shardeum Cosmos Chain

This directory contains the Shardeum Cosmos chain implementation that uses the Shardeum Cosmos
...
This chain implementation is used to demonstrate the integration of Shardeum Cosmos
...
To run the Shardeum chain, execute the local node script found within this repository:
...
For connecting to the Shardeum chain, we'll be using Metamask:
...
As mentioned above, this Shardeum chain implementation is a reduced version of `simapp`.
