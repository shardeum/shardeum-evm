...
// file.
func (app *ShardeumApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *ShardeumApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
