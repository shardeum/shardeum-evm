...
import (
	...
	erc20v2 "github.com/shardeum/shardeum-evm/x/erc20/v2"
	"github.com/shardeum/shardeum-evm/x/feemarket"
...
var (
	_ runtime.AppI                = (*ShardeumApp)(nil)
	_ cosmosevmserver.Application = (*ShardeumApp)(nil)
	_ ibctesting.TestingApp       = (*ShardeumApp)(nil)
)

// ShardeumApp extends an ABCI application, but with most of its parameters exported.
type ShardeumApp struct {
	*baseapp.BaseApp
...
// NewShardeumApp returns a reference to an initialized ShardeumApp.
func NewShardeumApp(
	logger log.Logger,
	db dbm.DB,
...
func (app *ShardeumApp) onPendingTx(hash common.Hash) {
...
func (app *ShardeumApp) RegisterPendingTxListener(listener func(common.Hash)) {
	app.pendingTxListeners = append(app.pendingTxListeners, listener)
}

func (app *ShardeumApp) setPostHandler() {
...
func (app *ShardeumApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *ShardeumApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *ShardeumApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *ShardeumApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (app *ShardeumApp) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *ShardeumApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *ShardeumApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *ShardeumApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns ShardeumApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *ShardeumApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns ShardeumApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *ShardeumApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns ShardeumApp's InterfaceRegistry
func (app *ShardeumApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns ShardeumApp's TxConfig
func (app *ShardeumApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (app *ShardeumApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *ShardeumApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *ShardeumApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *ShardeumApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// SimulationManager implements the SimulationApp interface
func (app *ShardeumApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *ShardeumApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *ShardeumApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *ShardeumApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *ShardeumApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *ShardeumApp) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *ShardeumApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *ShardeumApp) GetEVMKeeper() *evmkeeper.Keeper {
	return app.EVMKeeper
}

func (app *ShardeumApp) GetErc20Keeper() *erc20keeper.Keeper {
	return &app.Erc20Keeper
}

func (app *ShardeumApp) SetErc20Keeper(erc20Keeper erc20keeper.Keeper) {
	app.Erc20Keeper = erc20Keeper
}

func (app *ShardeumApp) GetGovKeeper() govkeeper.Keeper {
	return app.GovKeeper
}

func (app *ShardeumApp) GetEvidenceKeeper() *evidencekeeper.Keeper {
	return &app.EvidenceKeeper
}

func (app *ShardeumApp) GetSlashingKeeper() slashingkeeper.Keeper {
	return app.SlashingKeeper
}

func (app *ShardeumApp) GetBankKeeper() bankkeeper.Keeper {
	return app.BankKeeper
}

func (app *ShardeumApp) GetFeeMarketKeeper() *feemarketkeeper.Keeper {
	return &app.FeeMarketKeeper
}

func (app *ShardeumApp) GetFeeGrantKeeper() feegrantkeeper.Keeper {
	return app.FeeGrantKeeper
}

func (app *ShardeumApp) GetConsensusParamsKeeper() consensusparamkeeper.Keeper {
	return app.ConsensusParamsKeeper
}

func (app *ShardeumApp) GetAccountKeeper() authkeeper.AccountKeeper {
	return app.AccountKeeper
}

func (app *ShardeumApp) GetAuthzKeeper() authzkeeper.Keeper {
	return app.AuthzKeeper
}

func (app *ShardeumApp) GetDistrKeeper() distrkeeper.Keeper {
	return app.DistrKeeper
}

func (app *ShardeumApp) GetStakingKeeper() *stakingkeeper.Keeper {
	return app.StakingKeeper
}
...
func (app *ShardeumApp) GetTransferKeeper() transferkeeper.Keeper {
	return app.TransferKeeper
}

func (app *ShardeumApp) SetTransferKeeper(transferKeeper transferkeeper.Keeper) {
	app.TransferKeeper = transferKeeper
}

func (app *ShardeumApp) GetMempool() sdkmempool.ExtMempool {
	return app.EVMMempool
}

func (app *ShardeumApp) GetAnteHandler() sdk.AnteHandler {
	return app.BaseApp.AnteHandler()
}

// GetTxConfig implements the TestingApp interface.
func (app *ShardeumApp) GetTxConfig() client.TxConfig {
	return app.txConfig
}

func (app *ShardeumApp) SetClientCtx(clientCtx client.Context) {
...
func (app *ShardeumApp) AutoCliOpts() autocli.AppOptions {
