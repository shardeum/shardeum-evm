...
// NewRootCmd creates a new root command for shardeumd. It is called once in the
// main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:   "shardeumd",
		Short: "Shardeum EVM blockchain application",
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := shardeumdconfig.InitAppConfig(shardeumdconfig.ShardeumChainDenom(), shardeumdconfig.ShardeumChainID())
...
func initRootCmd(rootCmd *cobra.Command, evmApp *shardeumd.ShardeumApp) {
	cfg := sdk.GetConfig()
	cfg.Seal()
...
func appExport(
	...
	var shardeumApp *shardeumd.ShardeumApp
...
func getChainIDFromOpts(appOpts servertypes.AppOptions) (chainID string, err error) {
	...
	if chainID == "" {
		...
		chainID, err = shardeumdconfig.GetChainIDFromHome(homeDir)
		if err != nil {
			return "", err
		}
	}
