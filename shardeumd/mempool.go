...
func (app *ShardeumApp) configureEVMMempool(appOpts servertypes.AppOptions, logger log.Logger) error {
...
func (app *ShardeumApp) createMempoolConfig(appOpts servertypes.AppOptions, logger log.Logger) (*evmmempool.EVMMempoolConfig, error) {
