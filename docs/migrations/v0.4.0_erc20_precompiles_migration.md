...
The storage mechanism for ERC20 dynamic and native precompiles has fundamentally changed in Shardeum Cosmos v0.4.0. This migration is mandatory for chains with existing ERC20 token pairs.
